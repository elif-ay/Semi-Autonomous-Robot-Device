...
int main(int argc, char *argv[])
{
  ...
  while (ydlidar::os_isOk()){
    ...
    while (true){       
      ...
      int fd = open("/home/grup3/oto_robot/Code/Server/Mapping/robot/build/robot_location.txt",O_RDWR);
        
     int dosya = open("/home/grup3/oto_robot/Code/Server/Mapping/robot/build/lidardata.txt",O_RDWR);
       if (fd == -1) {
